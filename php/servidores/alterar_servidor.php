    ...
    <div class="col-xs-12 col-sm-8" style="margin-left:180px;">
        <div class="widget-box">
            ...
            <div class="widget-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <label for="form-field-select-3" data-rel="popover" data-trigger="hover"
                                ...
                                Servidor</label>
                            <br>
                            <input type="text" id="servidor_nome" value="<?php echo $dados['servidor_nome'] ?>"
                                class="form-control" />
                        </div>
                        <div class="col-sm-6">
                            <label for="form-field-select-3" data-rel="popover" data-trigger="hover"
                            ...
                            <br>
                            <input type="text" id="servidor_ip" value="<?php echo $dados['servidor_ip'] ?>"
                                class="form-control" />
                        </div>
                    </div>
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="form-field-select-3" data-rel="popover" data-trigger="hover"
                                    ...
                                    title="Sistema Operacional deste servidor">Plataforma</label>
                                <br>
                                <select class="chosen-select form-control" id="servidor_plataforma"
                                    data-placeholder="Selecione">
                                    <option value="<?php echo $dados['servidor_plataforma'] ?>">
                                        <?php echo $dados['servidor_plataforma'] ?></option>
                                    <?php
                            ...
                            <div class="col-sm-6">
                                <label for="form-field-select-3" data-rel="popover" data-trigger="hover"
                                    data-placement="bottom"
                                    title="Usuário com privilégios de Administrador do Servidor">Login do
                                    Servidor</label>
                                <br>
                                <input type="text" id="servidor_user_privilegio"
                                    value="<?php echo $dados['servidor_user_privilegio'] ?>" class="form-control" />
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div>
                                <div class="col-sm-6">
                                    <label for="form-field-select-3" data-rel="popover" data-trigger="hover"
                                        data-placement="bottom"
                                        title="Senha do usuário com privilégios de Administrador do Servidor">Senha</label>
                                    <br>
                                    <input type="password" id="servidor_senha_acesso"
                                        value="<?php echo base64_decode($dados['servidor_senha_acesso']) ?>"
                                        class="form-control" />
                                </div>
                                <div class="col-sm-6">
                                    <label for="form-field-select-3" data-rel="popover" data-trigger="hover"
                                        data-placement="bottom" title="Compartilhamento onde será salvo os backups">Nome
                                        do Compartilhamento</label>
                                    <br>
                                    <input type="text" id="servidor_nome_compartilhamento"
                                        value="<?php echo $dados['servidor_nome_compartilhamento'] ?>"
                                        class="form-control" />
                                </div>
                            </div>
                        </div>
                ...
                <br>
                <center>
                    <button type="button" class="btn btn-primary" onclick="alterar_servidor()"
