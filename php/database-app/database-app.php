...
$conexao = conectar();
$sql = $conexao->prepare("SELECT * FROM aplicacao WHERE app_id != 1 ORDER BY app_nome");
$sql->execute();
?>
<div class="container">
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Aplicações</h3>
    <div class="clearfix">
      <div class="pull-right tableTools-container"> <a href="cadastro_app.php"><button type="button" id="cadastrar"  class="btn btn-primary btn-sm">Adicionar</button></a></div>
    </div>
    ...
    <div>
      <table id="table" class="table table-striped table-bordered table-hover">
        <thead>
          <tr>
            <th class="hidden-480">Código da Aplicações</th>
            <th class="hidden-480">Nome da Aplicações</th>
            <th class="hidden-480">Descrição da Aplicações</th>
