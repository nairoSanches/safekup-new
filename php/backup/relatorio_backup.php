...
$conexao = conectar();
$sql = $conexao->prepare("SELECT backup_data,backup_origem,bd_nome_usuario,backup_status FROM computadores A JOIN backups_realizados B ON A.bd_id = B.backup_id_computador ORDER BY backup_data DESC");
$sql->execute();
?>
<div class="container">
<div class="row">
      ...
      <table id="table" class="table table-striped table-bordered table-hover">
        ...
        <tbody>
          <?php while($dados = $sql->fetch(PDO:: FETCH_ASSOC)) {
            ...
            ?>
          <tr>
						<td><?php echo $dados["bd_nome_usuario"]?></td>
