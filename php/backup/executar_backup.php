                    ...
                    <div class="widget-main">
                      <div class="row">
                          <div class="col-sm-4"style="margin-left:210px;">
                            ...
                            <select id="bd_id" class="chosen-select form-control">
                            <option value="">Buscar ...</option>
                                <?php
                                $sql = mysqli_query($conexao,"SELECT * FROM computadores ORDER BY bd_nome_usuario");
                                while($computadores = mysqli_fetch_array($sql))
                                    echo "<option value='$computadores[bd_id]'>$computadores[bd_nome_usuario]</option>";
                                ?>
                            </select>
                        </div>
                    </div>
