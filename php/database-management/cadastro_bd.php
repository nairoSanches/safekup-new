  ...
  <div class="col-xs-12 col-sm-8" style="margin-left:210px;">
    <div class="widget-box">
      ...
      <div class="widget-body">
        <div class="widget-main">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <select id="tipo_id" class="chosen-select form-control">
          ...
          <div class="row">
            <div class="col-sm-4">
              <label for="form-field-select-3" data-rel="popover" data-trigger="hover" data-placement="bottom"
                title="Escolha o horário do backup automático">Horário</label>
              <br>
        ...
        <center>
          <button type="button" class="btn btn-primary" onclick="cadastrar_bd()"
            id="cadastrar_bd">CADASTRAR</button>
