...
if(isset($_GET['usuario_id'])){
  ...
  $sql = mysqli_query($conexao,"SELECT * FROM usuario A  WHERE usuario_id = '$usuario_id' ");
        ...
        <div class="col-xs-12 col-sm-8" style="margin-left:180px;">
            <div class="widget-box">
                <div class="widget-header">
                    ...
                    <span style="margin-left:73%" class="help-button" data-rel="popover" data-trigger="hover" data-placement="bottom" title="Cadastro de usuários do safekup">?</span>
                </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <br>
                                <select id="app_id" class="chosen-select form-control" data-placeholder="Selecione">
