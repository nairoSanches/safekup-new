...
// Create a message
$data = date('d/m/Y');
$message = (new Swift_Message('Dados de Acesso safekup  ' .$data))
->setFrom([$username => 'Suporte safekup'])
->setTo([$usuario_email])
